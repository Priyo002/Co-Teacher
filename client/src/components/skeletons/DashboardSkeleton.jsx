    ...
    <div className="p-8 md:p-12 animate-pulse max-w-[1400px] mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 gap-6">
        ...
        <div className="flex items-center gap-4 w-full sm:w-auto">
          <div className="h-12 w-full sm:w-96 md:w-[400px] bg-slate-100 rounded-xl border border-slate-200"></div>
          <div className="h-12 w-40 bg-slate-200 rounded-xl hidden sm:block"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="bg-white rounded-3xl p-8 border border-slate-200 h-40 flex flex-col justify-center relative overflow-hidden">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-slate-100"></div>
              <div className="h-4 w-24 bg-slate-100 rounded-md"></div>
            </div>
            <div className="h-12 w-16 bg-slate-200 rounded-xl"></div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-12">
        ...
        <div className="xl:col-span-2 flex flex-col">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 h-[280px] p-8 flex flex-col flex-1">
        ...
        <div className="xl:col-span-1 flex flex-col h-full">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 flex-1 p-6 flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
          <div key={i} className="bg-white rounded-3xl border border-slate-200 h-80 p-8 flex flex-col">
            <div className="flex items-start justify-between mb-6">
              <div className="w-14 h-14 bg-slate-100 rounded-2xl"></div>
            </div>
